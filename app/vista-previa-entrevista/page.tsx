      ...
      >
        <div className="relative flex min-h-0 flex-1 flex-col overflow-hidden bg-background">
          <div className="min-h-0 flex-1 overflow-y-auto">
            <div className="mx-auto flex min-w-0 w-full max-w-[760px] flex-col gap-6 px-3 py-8 md:gap-8 md:px-4">
              <div className="w-fit max-w-[min(92%,100%)] rounded-3xl rounded-bl-md bg-card/90 px-4 py-2.5 text-base leading-[1.7] shadow-[var(--shadow-card)]">
                Hola, Alex. Para empezar: ¿qué cambió en el último trimestre?
              </div>
              <div className="ml-auto w-fit max-w-[min(88%,100%)] overflow-hidden break-words rounded-3xl rounded-br-md border border-border/30 bg-gradient-to-br from-secondary to-muted px-4 py-2.5 text-base leading-[1.7] shadow-[var(--shadow-card)]">
                Cerramos dos cuentas y el comité pidió más claridad en
                membresías.
              </div>
            </div>
          </div>
          <div className="mx-auto flex w-full max-w-[760px] shrink-0 gap-2 bg-background px-3 pb-3 md:px-4 md:pb-4">
